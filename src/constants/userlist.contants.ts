...
export const USER_SERVER_API_UPLOAD :string= USER_SERVER_API + "upload/";

export const USER_SERVER_API_USER_LIST :string	 = USER_SERVER_API_USER;
export const USER_SERVER_API_USER_ADD :string	 = USER_SERVER_API_USER + "add/"
export const USER_SERVER_API_USER_DELETE :string = USER_SERVER_API_USER + "delete/"
export const USER_SERVER_API_USER_GET :string	 = USER_SERVER_API_USER + "get/"
